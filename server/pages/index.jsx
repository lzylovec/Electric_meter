  ...
  <div className={styles.container}>
    ...
    <div className={styles.controls}>
      <div className={styles.field}>
        ...
        <div className={`${styles.dropzone}`} onClick={()=>document.getElementById('excelFile').click()} onDragOver={e=>{e.preventDefault();e.currentTarget.classList.add(styles.isDrag)}} onDragLeave={e=>{e.currentTarget.classList.remove(styles.isDrag)}} onDrop={e=>{e.preventDefault();e.currentTarget.classList.remove(styles.isDrag);const f=e.dataTransfer&&e.dataTransfer.files?e.dataTransfer.files[0]:null;setFile(f);setFileName(f?f.name:'')}}>
          拖拽文件到此或点击选择
        </div>
